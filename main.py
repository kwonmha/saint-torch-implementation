...
save_path = data_set_name[:-4] + "_d{}_l{}_dr{}_lr{}_b{}.pt".format(
                        args.h_dim, args.n_layers, args.dropout_rate, args.lr, args.batch_size)
...
for epoch in range(args.epochs):
    ...
    for i, data in enumerate(train_loader):
        ...
        label_mask = torch.masked_select(labels.to(device), mask)
